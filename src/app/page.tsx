      ...
      <section style={{ paddingTop: 'clamp(3.5rem, 7vw, 6rem)', paddingBottom: 'clamp(4rem, 8vw, 7rem)' }}>
        <div className="container">
          <div style={{ maxWidth: '840px' }}>
            ...
            >
              Rank on Google and get cited by ChatGPT and AI Overviews — built for a handful of industries we know deeply, not everyone.
            </p>

            {/* Bullet points with checkmarks */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '2.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', fontSize: 'clamp(0.95rem, 1.8vw, 1.08rem)', fontWeight: 600, color: '#ffffff' }}>
        ...
        <div className="container">
          ...
          <div style={{ backgroundColor: '#111111', border: '1px solid #222222', borderRadius: '24px', padding: 'clamp(1.75rem, 4vw, 3.5rem)' }}>
            <div className="simulator-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'center' }}>
              ...
              {/* Output Display */}
              <div style={{ backgroundColor: '#000000', border: '1px solid #222222', color: '#ffffff', borderRadius: '20px', padding: 'clamp(2rem, 4vw, 3.5rem)' }}>
